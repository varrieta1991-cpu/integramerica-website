...
const steps = [
  {
    ...
    detail: 'Photo, scan, or original — we\'ll let you know exactly what we need.',
  },
  {
    number: '02',
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        ...
        <ScrollReveal delay={400} className="mt-16 pt-12 border-t border-white/10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
          <p className="text-white/60 text-base max-w-md">
            Ready to get started? Send us your document on WhatsApp and we'll get back to you within the hour.
          </p>
          <a
            href={WHATSAPP_HREF}
            target="_blank"
            rel="noopener noreferrer"
            className="shrink-0 inline-flex items-center gap-2 bg-[#C9A84C] hover:bg-[#b8943e] text-[#0C1628] font-bold text-sm px-7 py-4 transition-colors duration-200"
          >
