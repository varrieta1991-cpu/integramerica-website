      ...
      <div className="relative z-20 w-full max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 pt-28 pb-20 lg:pt-36 lg:pb-28">
        <div className="max-w-3xl">
          ...
          <h1 className="font-serif text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold text-white leading-[1.08] mb-6 opacity-0 animate-[fadeInUp_0.7s_cubic-bezier(0.22,1,0.36,1)_0.2s_forwards]">
            Your Document Experts in the United States
          </h1>

          {/* Subheadline */}
          <p className="text-white/70 text-base sm:text-lg lg:text-xl leading-relaxed mb-10 max-w-2xl opacity-0 animate-[fadeInUp_0.7s_cubic-bezier(0.22,1,0.36,1)_0.35s_forwards]">
            Hague Apostille · Consular Legalization · Certified Translations ·
            Immigration Advisory — Serving all 50 states since 2004.{' '}
